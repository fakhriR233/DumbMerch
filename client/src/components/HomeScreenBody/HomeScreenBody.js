            ...
            <Col style={Styles.CardCol} key={id}>
              ...
              >
                <Card style={Styles.CardBody}>
                  ...
                  />
                  <Card.Body>
                    <Card.Title style={{ color: "#F74D4D" }}>
                      {items.title}
                    </Card.Title>
                    <Card.Text>Rp. {items.price}</Card.Text>
                    <Card.Text className="mt-0">Stock : {items.qty}</Card.Text>
                  </Card.Body>
                </Card>
              </Link>
            </Col>
